...
Figura ilustrativa de um código em Dockerfile usando o Visual Studio Code. This picture shows a Dockerfile code using the Visual Studio. Figura que muestra un código Dockerfile usando el Visual Studio.
