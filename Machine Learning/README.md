...
Machine learning usando o algoritmo de rede neural LSTM - Machine learning using neural network algorithm LSTM. Observed datas(green line) and forecast(red line) - Aprendizaje de máquina utilizando el algoritmo de red neuronal LSTM.Datos observados(línea verde) y pronóstico(línea roja).
...
+ tensorflow.py - Machine learning test using the neural network LSTM in the meteorological datas.
...
+ tensorflow.png - Picture generated by the machine learning using the neural network LSTM.
