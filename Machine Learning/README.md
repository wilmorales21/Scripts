...
+ Machine_learning(Tensorflow).png - Figura gerada pelo machine learning usando o algoritmo Tensorflow.
...
+ Machine learning(Tensorflow).png - Picture generated by the machine learning using the Tensorflow algorithm.
...
+ Machine_learning(Tensorflow).png - Figura generada por lo aprendizaje de maquina utilizando el algoritmo Tensorflow.
