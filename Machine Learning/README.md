...
+ Machine_learning(Random_Forest) - Picture generated by the machine learning using the Random Forest algorithm.
+ Machine_learning(Catboost) - Picture generated by the machine learning using the Catboost algorithm.
