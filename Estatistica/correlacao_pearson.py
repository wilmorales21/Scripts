...
#------------------------------------------------------------------
#Calculando a correlação de Pearson para estimar o grau de associação entre as variáveis A e B
...
#Ajustando o valor da correlação e coeficiente linear para plotar no gráfico
correlacao_ajustada = round(correlacao,3)
print('CORRELAÇÃO AJUSTADA =',correlacao_ajustada)
coeficiente_linear_ajustado = round(coeficiente_linear,3)
print('COEFICIENTE LINEAR AJUSTADO =',coeficiente_linear_ajustado)
...
plt.text(0.1, 0.4, f'Inclinação: {inclinacao:.3f}', transform=plt.gca().transAxes)
...
#########################################################
#
# RODAR: python3 correlacao_pearson.py
#
#########################################################
