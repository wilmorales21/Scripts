...
plt.bar(x - 0.3, y1, width = largura, color='olivedrab', label='2009')
plt.bar(x - 0.1, y2, width = largura, color='deepskyblue',label='2011')
plt.bar(x + 0.1, y3, width = largura, color='mediumorchid',label='2019')
