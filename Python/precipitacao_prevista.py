# Este código calcula a precipitacao media prevista pelo modelo GEFS sobre a Bacia do Baixo Iguacu, 
# utilizando as informacoes de precipitacao prevista que estao armazenadas no aruivo NetCDF
# chamado precip-total_GEFSav_glob_20221212T00.nc com as informacoes da geometria da bacia que estao
# armazenadas no arquivo baixo_iguacu.shp
...
##################################################################
#
#           RODAR O CÓDIGO: python3 precipitacao_prevista.py
#
##################################################################
