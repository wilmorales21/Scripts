...
partir do arquivo de dados temperatura_diaria.csv. Foi plotado o gráfico de barras de precipitação mensal dos anos com correlação de Pearson acima de 0.70 pelo código precipitacao.py. Também foi plotada a evolução mensal do índice de El Niño Oscilação Sul(ENOS) entre os anos de 2000 e 2021 pelo código enso.py a partir do arquivo de dados enso.csv. Foi plotada a temperatura do ar no nível de pressão de 850hPa pelo código codigo_netcdf.py a partir de dados NetCDF que não estão neste repositório. 
